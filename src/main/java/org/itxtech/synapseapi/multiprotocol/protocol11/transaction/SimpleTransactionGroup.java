...
public class SimpleTransactionGroup implements TransactionGroup {
    ...
    public boolean execute(boolean force) {
        ...
        InventoryTransaction simpleInventoryTransaction = new InventoryTransaction(source, actions);
        InventoryTransactionEvent ev = new InventoryTransactionEvent(simpleInventoryTransaction); //TODO: convert
