...
public class LevelSoundEventPacket extends Packet11 {
    ...
    public LevelSoundEventPacket fromDefault(DataPacket pkk) {
        ClassUtils.requireInstance(pkk, cn.nukkit.network.protocol.LevelSoundEventPacket.class);

        cn.nukkit.network.protocol.LevelSoundEventPacket pk = (cn.nukkit.network.protocol.LevelSoundEventPacket) pkk;
        this.x = pk.x;
        this.y = pk.y;
        this.z = pk.z;
        this.pitch = pk.pitch;
        this.unknownBool = pk.isBabyMob;
        this.disableRelativeVolume = pk.isGlobal;
        this.sound = pk.sound;
        this.extraData = pk.extraData;
        return this;
    }

    public cn.nukkit.network.protocol.LevelSoundEventPacket toDefault() {
        cn.nukkit.network.protocol.LevelSoundEventPacket pk = new cn.nukkit.network.protocol.LevelSoundEventPacket();
        pk.x = x;
        pk.y = y;
        pk.z = z;
        pk.sound = sound;
