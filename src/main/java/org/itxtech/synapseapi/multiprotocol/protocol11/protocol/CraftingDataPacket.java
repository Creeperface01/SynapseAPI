 ...
 */
public class CraftingDataPacket extends Packet11 {
    ...
    public CraftingDataPacket fromDefault(DataPacket pkk) {
        ClassUtils.requireInstance(pkk, cn.nukkit.network.protocol.CraftingDataPacket.class);

        cn.nukkit.network.protocol.CraftingDataPacket pk = (cn.nukkit.network.protocol.CraftingDataPacket) pkk;
        this.entries = pk.entries;
        this.cleanRecipes = pk.cleanRecipes;
        return this;
    }

    public cn.nukkit.network.protocol.CraftingDataPacket toDefault() {
        cn.nukkit.network.protocol.CraftingDataPacket pk = new cn.nukkit.network.protocol.CraftingDataPacket();
        pk.entries = entries;
        pk.cleanRecipes = cleanRecipes;
        return pk;
    }
