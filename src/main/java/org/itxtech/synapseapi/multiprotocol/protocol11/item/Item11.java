package org.itxtech.synapseapi.multiprotocol.protocol11.item;
...
public class Item11 {
    ...
    public static void init() {
        if (list == null) {
            ...
            list[GHAST_TEAR] = Item.class; //370
            ...
            list[EMPTY_MAP] = Item.class; //395
            list[GOLDEN_CARROT] = Item.class; //396
            ...
            list[RABBIT_HIDE] = Item.class; //415
            ...
            list[LEAD] = Item.class; //420
            list[NAME_TAG] = Item.class; //421
            ...
            list[CHORUS_FRUIT] = Item.class; //432
            list[POPPED_CHORUS_FRUIT] = Item.class; //433

            list[DRAGON_BREATH] = Item.class; //437
            list[SPLASH_POTION] = ItemPotionSplash.class; //438

            list[LINGERING_POTION] = Item.class; //441

            list[ELYTRA] = ItemElytra.class; //444

            list[SHULKER_SHELL] = Item.class; //445
    ...
    public static boolean exist(Item item) {
        return exist(item.getId());
    }
    ...
    public static Item check(Item item) {
        ...
        return exist(item) ? item : getUpdateItem();
    }

    private static final Item updateItem = Item.get(248);
