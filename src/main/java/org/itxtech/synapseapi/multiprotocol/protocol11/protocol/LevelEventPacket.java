 ...
 * Nukkit Project
 */
public class LevelEventPacket extends Packet11 {
    ...
    public LevelEventPacket fromDefault(DataPacket pkk) {
        ClassUtils.requireInstance(pkk, cn.nukkit.network.protocol.LevelEventPacket.class);

        cn.nukkit.network.protocol.LevelEventPacket pk = (cn.nukkit.network.protocol.LevelEventPacket) pkk;
        this.x = pk.x;
        this.y = pk.y;
        this.z = pk.z;
        this.evid = pk.evid;
    ...
    public cn.nukkit.network.protocol.LevelEventPacket toDefault() {
        cn.nukkit.network.protocol.LevelEventPacket pk = new cn.nukkit.network.protocol.LevelEventPacket();
        pk.x = x;
        pk.y = y;
        pk.z = z;
        pk.evid = evid;
