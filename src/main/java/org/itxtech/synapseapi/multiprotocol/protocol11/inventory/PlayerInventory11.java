package org.itxtech.synapseapi.multiprotocol.protocol11.inventory;
 ...
 * @author CreeperFace
 */
public class PlayerInventory11 extends PlayerInventory {

    protected final int[] hotbar;

    public PlayerInventory11(EntityHumanType player) {
        super(player);
    ...
    public void setHeldItemSlot(int slot) {
        if (slot >= -1 && slot < this.getSize()) {
            ...
            if (this.getHolder() instanceof Player) {
                PlayerItemHeldEvent ev = new PlayerItemHeldEvent((Player) this.getHolder(), item, itemIndex);
