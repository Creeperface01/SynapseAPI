...
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AddEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AddHangingEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AddItemEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AddPaintingPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AddPlayerPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AdventureSettingsPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AnimatePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.AvailableCommandsPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.BlockEntityDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.BlockEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.BlockPickRequestPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.BossEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ChangeDimensionPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ChunkRadiusUpdatedPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ClientboundMapItemDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.CommandStepPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ContainerClosePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ContainerOpenPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ContainerSetContentPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ContainerSetDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ContainerSetSlotPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.CraftingDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.CraftingEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.DisconnectPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.DropItemPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.EntityEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.EntityFallPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ExplodePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.FullChunkDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.GameRulesChangedPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.HurtArmorPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.InteractPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ItemFrameDropItemPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.LevelEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.LevelSoundEventPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.LoginPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.MapInfoRequestPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.MobArmorEquipmentPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.MobEquipmentPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.MoveEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.MovePlayerPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.PlaySoundPacket;
...
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.PlayerInputPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.PlayerListPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ProtocolInfo;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.RemoveBlockPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.RemoveEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ReplaceItemInSlotPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.RequestChunkRadiusPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePackChunkDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePackChunkRequestPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePackClientResponsePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePackDataInfoPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePackStackPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ResourcePacksInfoPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.RespawnPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.RiderJumpPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetCommandsEnabledPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetDifficultyPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetEntityDataPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetEntityLinkPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetEntityMotionPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetHealthPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetPlayerGameTypePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetSpawnPositionPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetTimePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SetTitlePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.ShowCreditsPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.SpawnExperienceOrbPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.StartGamePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.TakeItemEntityPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.TextPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.UpdateAttributesPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.UpdateBlockPacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.UpdateTradePacket;
import org.itxtech.synapseapi.multiprotocol.protocol11.protocol.UseItemPacket;
